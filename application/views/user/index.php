				...
				<div class="card">
					<div class="card-body px-3 py-4-5">
						<div class="row">
							...
							<div class="col-md-8">
								<h6 class="text-muted font-semibold">Stok Barang</h6>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h4>Profile Visit / Perkenalan Profile : <?= $dashboard['title'] ?></h4>
					</div>
					<div class="card-body">
			...
			<div class="card-body py-4 px-5">
				<div class="d-flex align-items-center">
					<div class="avatar avatar-xl">
						...
						<img src="<?= base_url('assets/img/profile/'.$user['image']) ?>" alt="Face 1">
					</div>
					<div class="ms-3 name">
