        ...
        <div class="col-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <?= form_error('article_type', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
                    <div class="flash-data" data-flashdata="<?= $this->session->flashdata('flash'); ?>" data-objek="article_type"></div>
                                ...
                                <?php foreach ($article_types as $article_type) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" class="badge bg-success update" data-bs-toggle="modal" data-bs-target="#editModal" data-id="<?= $article_type['id'] ?>" data-article_type="<?= $article_type['article_type'] ?>">Change</a>
