        ...
        <div class="col-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="flash-data" data-flashdata="<?= $this->session->flashdata('flash'); ?>" data-objek="fish food"></div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover" id="dataTableExample">
                            ...
                            <tbody>
                                <?php $no = 1; ?>
                                <?php foreach ($fish_foods as $fish_food) : ?>

                                    <tr>
                                        <td><?= $no++ ?></td>
                                        <td><?= $fish_food['food'] ?></td>
                                        <td>
                                            <a href="<?= base_url("DataMaster/FishFood/delete/$fish_food[id]"); ?>" class="badge bg-danger tombol-hapus" data-hapus="fish">Delete</a>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addModalLabel">Add Fish Food</h1>
