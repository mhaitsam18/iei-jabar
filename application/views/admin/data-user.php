		...
		<div class="modal-content">
			...
			<form action="<?= base_url('Admin/dataUser') ?>" method="post">
				...
				<div class="modal-body">
					...
					<div class="mb-3">
						<label for="birthday" class="form-label">Birthday</label>
						<input type="date" class="form-control <?= (form_error('birthday')) ? 'is-invalid' : '' ?>" id="birthday_edit" name="birthday" placeholder="Birthday" value="<?= set_value('birthday') ?>">
						<div class="form-control-icon">
							<i class="bi bi-shield-lock"></i>
						</div>
						<?= form_error('birthday', '<small class="text-danger pl-3">', '</small>') ?>
					...
					<script>
						...
						const birthdayInput2 = document.getElementById('birthday_edit');
						...
						birthdayInput2.setAttribute('max', maxDateFormatted);
					</script>
					<div class="mb-3">
						<label for="phone_number" class="form-label">Phone Number</label>
						<input type="number" class="form-control <?= (form_error('phone_number')) ? 'is-invalid' : '' ?>" id="phone_number" name="phone_number" placeholder="Phone Number" value="<?= set_value('phone_number') ?>">
