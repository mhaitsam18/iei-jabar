...
(4, 'Conodonta', NULL, 9, 3, 1, 2, 'diklasifikasikan dalam kelas Conodonta. Selama bertahun-tahun, mereka hanya diketahui dari elemen oral mirip gigi yang ditemukan di pengasingan dan sekarang disebut elemen conodont. Pengetahuan mengenai jaringan halus masih terbatas.', NULL, NULL, '2023-06-10 19:56:27', '2023-06-10 19:56:27'),
(5, 'Placodermi', 'ikan berperisai', 9, 3, 2, 3, 'Placodermi (Dari bahasa yunani πλάξ = Perisai dan δέρμα = Kulit) adalah spesies ikan berperisai yang telah punah, diketahui dari fossilnya, spesies ini hidup diantara periode Silur, hingga periode Devon (periode) akhir. Kepala ikan ini, dilindungi oleh plat keras, sedangkan, seluruh bagian tubuh lainnya tidak diselimuti oleh perisai ini. Taxa Placodermi, dianggap sebagai paraphyleti yang berkerabat dengan seluruh ikan yang hidup saat ini.', NULL, NULL, '2023-06-10 19:58:34', '2023-06-10 19:58:34'),
(6, 'Chondrichthyes', 'ikan bertulang rawan', 9, 3, 2, 3, 'Chondrichthyes atau ikan bertulang rawan adalah ikan berahang, mempunyai sirip berpasangan, lubang hidung berpasangan, sisik, jantung beruang dua, dan rangka yang terdiri atas tulang rawan bukan tulang sejati. Mereka dibagi menjadi dua subkelas: Elasmobranchii (Hiu dan Pari ) dan Holocephali (kimera atau hiu hantu, terkadang dipisahkan menjadi kelas tersendiri).', NULL, NULL, '2023-06-10 19:58:34', '2023-06-10 19:58:34'),
(7, 'Acanthodii', 'ikan Basal', 9, 3, 2, 3, 'Acanthodii atau acanthodians adalah kelas gnathostom yang telah punah. Mereka saat ini dianggap mewakili tingkat parafiletik dari berbagai garis keturunan ikan basal hingga Chondrichthyes yang masih ada, yang mencakup hiu, pari, dan chimaera yang masih hidup.', NULL, NULL, '2023-06-10 19:58:34', '2023-06-10 19:58:34'),
(8, 'Actinopterygii', 'ikan bersirip kipas', 9, 3, 2, 4, 'Actinopterygii (/ˌæktɪnɒptəˈrɪdʒiaɪ/; dari actino-, berarti \"memiliki kipas\", dan bahasa Yunani Kuno πτέρυξ (ptérux), berarti \"sayap, sirip\"), yang anggotanya disebut sebagai ikan bersirip kipas, adalah klad (secara tradisi diklasifikasikan sebagai kelas atau subkelas) ikan bertulang.[1] Mereka mencakup 50% dari spesies vertebrata yang masih hidup.', NULL, NULL, '2023-06-10 19:58:34', '2023-06-10 19:58:34'),
(9, 'Sarcopterygii', 'ikan bersirip cuping', 9, 3, 2, 4, 'Sarcopterygii - Crossopterygii merupakan kelas dari Chordata bertulang sejati yang mengembangkan anggota badan berciri mirip tungkai: tebal, berdaging, dan juga memiliki tulang. Anggotanya adalah \"ikan hantu\" (coelacanth), ikan paru, dan semua Tetrapoda (\"hewan berkaki empat\", yaitu semua vertebrata selain ikan). Coelacanth dan ikan paru dikelompokkan dalam pustaka-pustaka klasik masa lalu sebagai \"ikan bersirip cuping\", tetapi pengelompokan ini bersifat parafiletik (tidak mencakup semua anggota). Nama \"Sarcopterygii\" dibentuk dari dua kata bahasa Yunani: σαρξ, sarx atau \"daging\", dan πτερυξ, pteryx atau \"sirip\" (\"hewan bersirip daging\"); sementara nama \"Crossopterygii\" dibentuk dari kata κροσσός, krossos atau \"cuping\", dan πτερυξ, pteryx atau \"sirip\" (\"hewan bersirip cuping\").', NULL, NULL, '2023-06-10 19:58:34', '2023-06-10 19:58:34'),
(10, 'Mammalia laut', 'ikan seperti paus dan lumba-lumba', 9, 3, 2, NULL, NULL, NULL, 128, '2023-06-11 02:29:58', '2023-06-11 02:29:58'),
(11, 'Cephalaspidomorphi', 'ikan tak berahang (primitif)', 9, 3, NULL, NULL, 'Cephalaspidomorphs adalah sekelompok ikan tanpa rahang yang dinamai Cephalaspis dari osteostracans. Sebagian besar ahli biologi menganggap takson ini telah punah, tetapi nama ini kadang-kadang digunakan dalam klasifikasi lamprey, karena lamprey pernah dianggap berkerabat dengan sefalaspid. Jika lamprey dimasukkan, mereka akan memperluas jangkauan kelompok yang diketahui dari periode Silurian dan Devonian hingga saat ini. Mereka adalah kerabat terdekat ikan berahang, yang muncul dari dalam diri mereka dan akan bertahan hidup jika ikan berahang dimasukkan.', NULL, NULL, '2023-06-11 02:38:31', '2023-06-11 02:38:31'),
...
CREATE TABLE `fish` (
  ...
  `length_max` varchar(255) NOT NULL,
